...
const FunctionalityPdfAnnotatorIcon: FC<{ name: string } & SvgIconProps> = ({
  ...
  const renderIcon = () => {
    switch (name) {
      ...
      case 'Create': {
        return <CreateIcon {...restProps} />
      }
      case 'AddCard': {
        return <AddCardIcon {...restProps} />
      }
      case 'TextIncrease': {
        return <TextIncreaseIcon {...restProps} />
      }
      case 'Image': {
      ...
      case 'HighlightOff': {
        return <HighlightOffIcon {...restProps} />
      }
      case 'TipsAndUpdates': {
        return <TipsAndUpdatesIcon {...restProps} />
      }
