...
// 定义通过ref暴露的方法的接口
export interface IIFunctionalityCommonSignaturePadPropsHandles {
  getPngBase64: () => string
}
interface IFunctionalityCommonSignaturePadProps {
  bottomView: (isValuable: boolean) => React.ReactNode
}
/**
 * 签名手绘板
 */
const FunctionalityCommonSignaturePad: ForwardRefRenderFunction<
  IIFunctionalityCommonSignaturePadPropsHandles,
  IFunctionalityCommonSignaturePadProps
> = ({ bottomView }, ref) => {
...
export default forwardRef(FunctionalityCommonSignaturePad)
