...
interface IFunctionalityCommonSignatureUploadProps {
  bottomView: (isValuable: boolean) => React.ReactNode
}
/**
 * 上传图片签名
 */
const FunctionalityCommonSignatureUpload: ForwardRefRenderFunction<
  IFunctionalityCommonSignatureUploadHandles,
  IFunctionalityCommonSignatureUploadProps
> = ({ bottomView }, ref) => {
...
export default forwardRef(FunctionalityCommonSignatureUpload)
