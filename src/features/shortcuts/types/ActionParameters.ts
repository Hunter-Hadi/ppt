...
interface ActionParameters {
  ...
  // set variable modal
  SetVariablesModalConfig?: any;
  CreateWebsiteContextConfig?: any;
  // 处理文本
  ActionTextHandleParameters?: any;
  // 消息
  ActionChatMessageType?: any['type'];
  ActionChatMessageOperationType?: 'add' | 'update' | 'delete';
  ActionChatMessageConfig?: any;
}
