...
const FunctionalityPdfExtractPageDetail = lazy(
  () =>
    import(
      '@/features/functionality_extract_page_pdf/components/FunctionalityPdfExtractPageDetail'
    ),
)
    ...
    >
      ...
      {fileList && (
        <Suspense fallback={<AppLoadingLayout loading />}>
          <FunctionalityPdfExtractPageDetail
            fileList={fileList}
