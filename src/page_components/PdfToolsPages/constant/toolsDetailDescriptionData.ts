...
export const allPdfToolsDetailDescriptionObject: {
  ...
  'compress-pdf': {
    ...
    operatingInstructions: {
      ...
      operationSteps: {
        title:
          'pages:pdf_tools__detail_description_object__compress_pdf__bottom_rightDescription_title',
        descriptionList: [
          'pages:pdf_tools__detail_description_object__compress_pdf__bottom_rightDescription_description_1',
          'pages:pdf_tools__detail_description_object__compress_pdf__bottom_rightDescription_description_2',
          'pages:pdf_tools__detail_description_object__compress_pdf__bottom_rightDescription_description_3',
          'pages:pdf_tools__detail_description_object__compress_pdf__bottom_rightDescription_description_4',
        ],
      },
    },
  },
